...
export class FoxWalletWallet {
    ...
    constructor(foxwallet) {
        ...
        _FoxWalletWallet_icon.set(this, icon);
        ...
        _FoxWalletWallet_on.set(this, (event, listener) => {
            __classPrivateFieldGet(this, _FoxWalletWallet_listeners, "f")[event]?.push(listener) || (__classPrivateFieldGet(this, _FoxWalletWallet_listeners, "f")[event] = [listener]);
        ...
        _FoxWalletWallet_connected.set(this, () => {
            const address = __classPrivateFieldGet(this, _FoxWalletWallet_foxwallet, "f").publicKey?.toBase58();
            if (address) {
                ...
                if (!account || account.address !== address || !bytesEqual(account.publicKey, publicKey)) {
                    __classPrivateFieldSet(this, _FoxWalletWallet_account, new FoxWalletWalletAccount({ address, publicKey }), "f");
        ...
        _FoxWalletWallet_connect.set(this, async ({ silent } = {}) => {
            if (!__classPrivateFieldGet(this, _FoxWalletWallet_account, "f")) {
                await __classPrivateFieldGet(this, _FoxWalletWallet_foxwallet, "f").connect(silent ? { onlyIfTrusted: true } : undefined);
            }
            __classPrivateFieldGet(this, _FoxWalletWallet_connected, "f").call(this);
            return { accounts: this.accounts };
        });
        _FoxWalletWallet_disconnect.set(this, async () => {
            await __classPrivateFieldGet(this, _FoxWalletWallet_foxwallet, "f").disconnect();
        });
        _FoxWalletWallet_signAndSendTransaction.set(this, async (...inputs) => {
            if (!__classPrivateFieldGet(this, _FoxWalletWallet_account, "f"))
            ...
            if (inputs.length === 1) {
                ...
                const { signature } = await __classPrivateFieldGet(this, _FoxWalletWallet_foxwallet, "f").signAndSendTransaction(VersionedTransaction.deserialize(transaction), {
                    preflightCommitment,
                    minContextSlot,
                    maxRetries,
                    skipPreflight,
                ...
                for (const input of inputs) {
                    outputs.push(...(await __classPrivateFieldGet(this, _FoxWalletWallet_signAndSendTransaction, "f").call(this, input)));
                }
            }
            return outputs;
        });
        _FoxWalletWallet_signTransaction.set(this, async (...inputs) => {
            ...
            if (inputs.length === 1) {
                ...
                const signedTransaction = await __classPrivateFieldGet(this, _FoxWalletWallet_foxwallet, "f").signTransaction(transaction);
                ...
                const signedTransactions = await __classPrivateFieldGet(this, _FoxWalletWallet_foxwallet, "f").signAllTransactions(transactions);
        ...
        _FoxWalletWallet_signMessage.set(this, async (...inputs) => {
            if (!__classPrivateFieldGet(this, _FoxWalletWallet_account, "f"))
                throw new Error('not connected');
            const outputs = [];
            if (inputs.length === 1) {
                ...
                if (account !== __classPrivateFieldGet(this, _FoxWalletWallet_account, "f"))
                    throw new Error('invalid account');
                const { signature } = await __classPrivateFieldGet(this, _FoxWalletWallet_foxwallet, "f").signMessage(message);
                outputs.push({ signedMessage: message, signature });
            }
            else if (inputs.length > 1) {
                for (const input of inputs) {
                    outputs.push(...(await __classPrivateFieldGet(this, _FoxWalletWallet_signMessage, "f").call(this, input)));
                }
            }
            return outputs;
        });
...
_FoxWalletWallet_listeners = new WeakMap(), _FoxWalletWallet_version = new WeakMap(), _FoxWalletWallet_name = new WeakMap(), _FoxWalletWallet_icon = new WeakMap(), _FoxWalletWallet_account = new WeakMap(), _FoxWalletWallet_foxwallet = new WeakMap(), _FoxWalletWallet_on = new WeakMap(), _FoxWalletWallet_connected = new WeakMap(), _FoxWalletWallet_disconnected = new WeakMap(), _FoxWalletWallet_reconnected = new WeakMap(), _FoxWalletWallet_connect = new WeakMap(), _FoxWalletWallet_disconnect = new WeakMap(), _FoxWalletWallet_signAndSendTransaction = new WeakMap(), _FoxWalletWallet_signTransaction = new WeakMap(), _FoxWalletWallet_signMessage = new WeakMap(), _FoxWalletWallet_instances = new WeakSet(), _FoxWalletWallet_emit = function _FoxWalletWallet_emit(event, ...args) {
    ...
    __classPrivateFieldGet(this, _FoxWalletWallet_listeners, "f")[event]?.forEach((listener) => listener.apply(null, args));
}, _FoxWalletWallet_off = function _FoxWalletWallet_off(event, listener) {
    __classPrivateFieldGet(this, _FoxWalletWallet_listeners, "f")[event] = __classPrivateFieldGet(this, _FoxWalletWallet_listeners, "f")[event]?.filter((existingListener) => listener !== existingListener);
